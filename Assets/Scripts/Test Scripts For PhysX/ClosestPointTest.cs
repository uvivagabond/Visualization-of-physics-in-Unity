...
public class ClosestPointTest : MonoBehaviour
{
	...
	void Update ()
	{
		closestPointOnCollider =	Physics.ClosestPoint (point: new Vector3 (0, 0), collider: col, position: tr.position, rotation: tr.rotation);
//		closestPoint =	col.ClosestPoint (position: new Vector3 (0, 0));
	...
	void OnDrawGizmos ()
	{
		GizmosForPhysics3D.VizualizeClosestPoint (point: new Vector3 (0, 0), 
			collider: col, 
